...
const file_cache_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\bR\x05value2\x85\x01\n" +
	"\x05cache\x12&\n" +
...
var file_cache_proto_depIdxs = []int32{
	0, // 0: pb.cache.Get:input_type -> pb.Request
	0, // 1: pb.cache.Set:input_type -> pb.Request
	0, // 2: pb.cache.Delete:input_type -> pb.Request
	1, // 3: pb.cache.Get:output_type -> pb.ResponseForGet
	1, // 4: pb.cache.Set:output_type -> pb.ResponseForGet
	2, // 5: pb.cache.Delete:output_type -> pb.ResponseForDelete
